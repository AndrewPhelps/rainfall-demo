...
// Map different lookup keys to the asset
const assetLookup: { [key: string]: typeof mjJersey } = {
  // By serial
  'EW3H-MRPQ': mjJersey,
  // By Rainfall short ID (from the URL)
  '6zxAj3pkVcmdp': mjJersey,
  // By full UUID
  'c501595e-4383-4e08-9868-d89888841941': mjJersey,
}
...
export async function GET(
  ...
  // Look up asset by serial, short ID, or UUID
  const asset = assetLookup[query]
